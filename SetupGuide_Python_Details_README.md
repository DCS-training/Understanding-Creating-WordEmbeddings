...
- We have placed the necessary python codebook (ipynb) connected to the tutorial on this repository and zipped data folder in this repository which you can clone and open in Noteable using EASE credentials. This way you will have an exact copy of the repository and work from the paths designed in there as follows:
